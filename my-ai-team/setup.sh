...
# my-ai-team - Multi-Agent Communication Demo Environment Setup
...
# multiagentセッションの作成（boss1 + 3 workers）
print_info "Creating multiagent session with 3 workers..."
...
print_success "🎉 my-ai-team environment is ready!"